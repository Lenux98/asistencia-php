<nav class="navbar navbar-expand-md navbar-dark bg-success fixed-top">
        <img class="img-fluid" style="width: 200px" src="img/images.jpeg" loading="lazy">
    </a>
    ...
    <div class="collapse navbar-collapse" id="menu">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="attendance_register.php">Registro de asisencia <i class="fa fa-check-double"></i></a>
            </li>
            <li class="nav-item">
